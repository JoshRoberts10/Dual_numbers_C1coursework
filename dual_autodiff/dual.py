...
class Dual:
    ...
    Dual numbers have particular applications in automatic differentiation, geometry and mathematical computing. For referances to any
    formulas used in this package please see the references below.
